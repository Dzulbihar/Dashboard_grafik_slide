        ...
        <div class="card">
          <div class="card-header">
            <figure class="highcharts-figure">
              <div id="grafik_market_share_box_international_bar"></div>
            </figure>
          </div>
        </div>
      </div>
...
Highcharts.chart('grafik_market_share_box_international_bar', {
    chart: {
        type: 'column'
    },
    title: {
        align: 'center',
        text: 'Grafik Market Share Box International'
    },
    subtitle: {
        align: 'center',
    ...
    series: [
        {
            ...
            <?php 
              $query = oci_parse($koneksi,     
                " 
                SELECT AGENT,JML_BOX from 
                (SELECT * from 
                (SELECT  AGENT,sum(JML_BOX) AS JML_BOX
