        ...
        <div class="card">
          <div class="card-header">
            <figure class="highcharts-figure">
              <div id="grafik_market_share_pendapatan_total_bar"></div>
            </figure>
          </div>
        </div>
      </div>
...
Highcharts.chart('grafik_market_share_pendapatan_total_bar', {
    chart: {
        type: 'column'
    },
    title: {
        align: 'center',
        text: 'Grafik Market Share Pendapatan Domestik & International'
    },
    subtitle: {
        align: 'center',
