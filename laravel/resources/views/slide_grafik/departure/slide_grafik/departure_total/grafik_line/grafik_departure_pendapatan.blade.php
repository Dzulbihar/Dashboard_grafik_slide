        ...
        <div class="card">
          <div class="card-header">
            <figure class="highcharts-figure">
              <div id="line_grafik_box_domestik_pendapatan"></div>
            </figure>
          </div>
        </div>
      </div>
...
Highcharts.chart('line_grafik_box_domestik_pendapatan', {
    chart: {
        type: 'spline'
    },
    title: {
        text: 
        'Grafik Departure TEUS Domestik & International' 
    },
    subtitle: {
        ...
        data: 
            ...
            <?php 
              $query4 = oci_parse($koneksi,     
                ...
                WHERE TAHUN=$tahun_ini AND BULAN<=$bulan AND TYPE='DOM' AND SATUAN='TOT_PEND' ORDER BY BULAN ASC
                "
              );
              oci_execute($query4);
