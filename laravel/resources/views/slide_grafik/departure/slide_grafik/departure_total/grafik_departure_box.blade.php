        ...
        <div class="card">
          <div class="card-header">
            <figure class="highcharts-figure">
              <div id="grafik_departure_box_total"></div>
            </figure>
          </div>
        </div>
      </div>
...
Highcharts.chart('grafik_departure_box_total', {
    chart: {
        type: 'column',
        options3d: {
          enabled: true,
    ...
    title: {
        text: 
        'Grafik Departure BOX Domestik & International' 
    },
    subtitle: {
        ...
        data: 
            ...
            <?php 
              $query4 = oci_parse($koneksi,     
                ...
                WHERE TAHUN=$tahun_ini AND BULAN<=$bulan AND SATUAN='BOX' GROUP BY BULAN ORDER BY BULAN ASC
                "
              );
              oci_execute($query4);
