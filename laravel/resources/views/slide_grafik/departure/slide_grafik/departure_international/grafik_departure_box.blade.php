        ...
        <div class="card">
          <div class="card-header">
            <figure class="highcharts-figure">
              <div id="grafik_departure_box_international"></div>
            </figure>
          </div>
        </div>
      </div>
...
Highcharts.chart('grafik_departure_box_international', {
    chart: {
        type: 'column',
        options3d: {
          enabled: true,
    ...
    title: {
        text: 
        'Grafik Departure BOX International' 
    },
    subtitle: {
        ...
        data:
            ...
            <?php 
              $query2 = oci_parse($koneksi,     
                " 
                SELECT SUM(JML_BOX) AS JML_BOX, BULAN_DEPARTURE FROM DASHBOARDGRAFIK.S_PROD_PEND_PERCUSTOMER 
        ...
        data: 
            ...
            <?php 
              $query4 = oci_parse($koneksi,     
                ...
                WHERE TAHUN=$tahun_ini AND BULAN<=$bulan AND TYPE='INT' AND SATUAN='BOX' ORDER BY BULAN ASC
                "
              );
              oci_execute($query4);
