        ...
        <div class="card">
          <div class="card-header">
            <figure class="highcharts-figure">
              <div id="grafik_departure_pendapatan_international"></div>
            </figure>
          </div>
        </div>
      </div>
...
Highcharts.chart('grafik_departure_pendapatan_international', {
    chart: {
        type: 'column',
        options3d: {
          enabled: true,
    ...
    title: {
        text: 
        'Grafik Departure Pendapatan International' 
    },
    subtitle: {
        ...
        data: 
            ...
            <?php 
              $query4 = oci_parse($koneksi,     
                ...
                WHERE TAHUN=$tahun_ini AND BULAN<=$bulan AND TYPE='INT' AND SATUAN='TOT_PEND' ORDER BY BULAN ASC
                "
              );
              oci_execute($query4);
