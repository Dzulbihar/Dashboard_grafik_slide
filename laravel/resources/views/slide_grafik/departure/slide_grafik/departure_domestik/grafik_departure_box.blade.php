        ...
        <div class="card">
          <div class="card-header">
            <figure class="highcharts-figure">
              <div id="grafik_departure_box_domestik"></div>
            </figure>
          </div>
        </div>
      </div>
...
Highcharts.chart('grafik_departure_box_domestik', {
    chart: {
        type: 'column',
        options3d: {
          enabled: true,
        ...
        data: 
            ...
            <?php 
              $query4 = oci_parse($koneksi,     
                ...
                WHERE TAHUN=$tahun_ini AND BULAN<=$bulan AND TYPE='DOM' AND SATUAN='BOX' ORDER BY BULAN ASC
                "
              );
              oci_execute($query4);
