...
Highcharts.chart('grafik_departure', {
    chart: {
        type: 'column',
        options3d: {
          enabled: true,
        ...
        data: 
            ...
            <?php 
              $query4 = oci_parse($koneksi,     
                ...
                WHERE TAHUN=$tahun_ini AND BULAN<=$bulan AND SATUAN='$satuan_rkap' GROUP BY BULAN ORDER BY BULAN ASC
                "
              );
              oci_execute($query4);
              while(($arus = oci_fetch_array($query4, OCI_BOTH)) != false)
