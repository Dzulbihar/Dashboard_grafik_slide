      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <form action="{{url('/nota/cari_nota')}}" method="GET">
              <p class="card-title"> 
                <b>Pilih Satuan</b> 
                ...
                <?php 
                if(isset($_GET['pilih_satuan'],$_GET['cari_tahun'],$_GET['cari_bulan'],$_GET['pilih_grafik'])){
...
<!-- /.content -->
  ...
  @include('slide_grafik.nota.slide_nota')
