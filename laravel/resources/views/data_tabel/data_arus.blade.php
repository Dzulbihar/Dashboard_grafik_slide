@section('header', 'Data Tabel Arus Perbulan')
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
			            <form action="{{url('/data_arus/cari_lokasi_data_arus')}}" method="GET">
			            	<p class="card-title"> 
			                	<b>Pilih Lokasi</b>
			                	<select name="cari_lokasi" id="cari_lokasi" class="btn btn-secondary btn-sm">
			                		@foreach($lokasi_data_arus as $lokasi)
			                	...
			                	<b>Pilih Tahun</b>
			                  	<select name="cari_tahun" id="cari_tahun" class="btn btn-secondary btn-sm">
			                		@foreach($tahun_data_arus as $tahun)
